...
export class Message extends Model {
    ...
    get type() {return this._data.content; }
                    ...
                    <div class="_3_7SH kNKwo tail">
                              ...
                              <div class="_1YNgi copyable-text">
                                  <div class="_3DZ69" role="button">
                                      ...
                                      <div class="_1lC8v">
                                          <div dir="ltr" class="_3gkvk selectable-text invisible-space copyable-text"></div>
                                      </div>
                                      <div class="_3a5-b">
                              ...
                              <div class="_1fnMt _2CORf">
                                  <a class="_1vKRe" href="#">
                                      ...
                                      <div class="_12xX7">
                                          ...
                                          <div class="nxILt">
                                              <span dir="auto" class="message-filename"></span>
                                          </div>
                                          <div class="_17viz">
                                  ...
                                  <div class="_3cMIj">
                                      <span class="PyPig message-file-info">32 paginas</span>
                                      <span class="PyPig message-file-type">PDF</span>
                                      <span class="PyPig message-file-size"></span>
                                  </div>
                                  <div class="_3Lj_s">
                                      <div class="_1DZAH" role="button">
                                          <span class="msg-time">18:56</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                    ...
                    <div class="font-style _3DFk6 tail">
                                ...
                                <div class="Tkt2p">
                                    <div class="_3zb-j ZhF0n">
                                        <span dir="ltr" class="selectable-text invisible-space message-text"></span>
                                    </div>
                                    <div class="_2f-RV">
                                        <div class="_1DZAH">
